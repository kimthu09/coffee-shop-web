        ...
        <div className="flex justify-between items-center mb-6 ">
          ...
          <div className=" ">
            ...
            <Input
              ...
              step={step}
              max={max}
              className="w-24 rounded-md border border-orange-400"
            />
          </div>
        </div>

        <div className="mb-4">
          <div className="slider relative h-1 rounded-md bg-orange-300">
            <div
              className="progress absolute h-1 bg-orange-300 rounded "
              ref={progressRef}
            ></div>
          </div>
